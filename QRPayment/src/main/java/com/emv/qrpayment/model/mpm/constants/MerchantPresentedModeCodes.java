package com.emv.qrpayment.model.mpm.constants;
...
public final class MerchantPresentedModeCodes {
  ...
  public static final String ID_MERCHANT_ACCOUNT_INFORMATION_RANGE_START = "29"; // (M) 2-51 Merchant Account Information
